...
void CreateObjects()
{
    ...
    Mesh* obj3 = new Mesh();
    obj3->CreateMesh(floorVertices, floorIndces, 32, 6);
...
void RenderScene()
{
    ...
    planeAngle -= 0.1f;
    if (planeAngle > 360.0f) planeAngle = 0.0f;

    model = glm::mat4(1.0f);
    model = glm::rotate(model, planeAngle * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
